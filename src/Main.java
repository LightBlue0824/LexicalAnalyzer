...
public class Main {
    ...
    private static int code;            //记录当前Token的code
    private static String string;       //记录当前Token的string
    private static int row;             //记录当前的行
    ...
    public static void main(String[] args){
        ...
        //输出
        try{
            IO.output(output, inputFileName);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    private static void recognizeToken(){
        switch (code){
            case -1:{       //换行
                row++;
                break;
